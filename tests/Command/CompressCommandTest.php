...
";
        ...
        for ($i = 0; $i < 5; $i++) {
            $this->assertFileExists("{$this->getRoot()->url()}/docs" . DIRECTORY_SEPARATOR . "Original_pratica_collaudata_$i.PDF");
            $this->assertStringContainsString(
                "INFO: Backup `vfs://root/docs" . DIRECTORY_SEPARATOR . "PraticaCollaudata_$i.PDF` into `vfs://root/docs" . DIRECTORY_SEPARATOR . "Original_pratica_collaudata_$i.PDF`.",
                $logContent
            );
...
";
        ...
        $this->assertStringContainsString(
            "ERROR: phootwork\\file\\exception\\FileException: Failed to copy vfs://root/docs" . DIRECTORY_SEPARATOR . "PraticaCollaudata_5.PDF to vfs://root/docs/Original_pratica_collaudata_5.PDF",
            $logContent
        );
        $this->assertFileDoesNotExist("vfs://root/docs/Original_pratica_collaudata_5.PDF");
